...
public class MeshData
{
    ...
    {
        Vector3 pointA = (a < 0) ? outOfMeshVertices[-a - 1] : vertices[a];
        Vector3 pointB = (b < 0) ? outOfMeshVertices[-b - 1] : vertices[b];
        Vector3 pointC = (c < 0) ? outOfMeshVertices[-c - 1] : vertices[c];
